...
images:
  background:
    src: /images/fantasy_world.jpeg
  chicken:
    src: /images/bunny_spritesheet.png
  coyote:
    src: /images/princess_sprite.png
...
<script type="module">
    ...
    import { initChicken } from '{{site.baseurl}}/assets/js/alienWorld/CharacterBunny.js';
